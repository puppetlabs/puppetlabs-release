platform "ubuntu-14.10-amd64" do |plat|
  ...
  plat.add_build_repository "http://pl-build-tools.delivery.puppetlabs.net/debian/pl-build-tools-release-utopic.deb"
  ...
  plat.vmpooler_template "ubuntu-1410-x86_64"
end
